...
func serveHTTP() {
	...
	router.POST("/stream/receiver", HTTPAPIServerStreamWebRTCByUrl)
	router.GET("/stream/codec/:uuid", HTTPAPIServerStreamCodec)
	router.GET("/stream/codec", HTTPAPIServerStreamCodecByUrl)
...
func HTTPAPIServerStreamCodecByUrl(c *gin.Context) {
	url := c.Query("url")

	if url == "" {
		c.JSON(http.StatusBadRequest, ResponseError{Error: "URL is required"})
		return
	}
...
func HTTPAPIServerStreamWebRTCByUrl(c *gin.Context) {
